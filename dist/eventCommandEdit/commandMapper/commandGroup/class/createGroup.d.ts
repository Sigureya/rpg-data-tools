...
export declare const createCommentGroup: (hedder: Command_Comment, bodies?: Command_CommentBody[]) => CombinedEventCommandGroup<Command_Comment, Command_CommentBody>;
