...
export declare const collectEventCommands: <Result, Command>(map: MapEventContainer<Command>, fn: (page: NonNullable<(typeof map)["events"][number]>["pages"][number], pageIndex: number, container: NonNullable<(typeof map)["events"][number]>) => Result[]) => Result[];
