...
export declare const collectMapEvents: <Result, Command>(map: MapEventContainer<Command>, fn: (page: NonNullable<(typeof map)["events"][number]>["pages"][number], pageIndex: number, container: NonNullable<(typeof map)["events"][number]>) => Result[]) => Result[];
...
export declare const processCommonEvents: <T>(events: ReadonlyArray<Data_CommonEvent>, func: (common: Readonly<Data_CommonEvent>, index: number, common2: {
    id: number;
}) => T) => T[];
