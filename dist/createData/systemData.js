...
export const createSystemData = (system = {}) => ({
    local: system.local ?? "",
...
export const createTerms = (proto = {}) => ({
...
export const createBasicTerms = (proto = {}) => [
    proto.level ?? "",
    proto.levelA ?? "",
    proto.hp ?? "",
    proto.hpA ?? "",
...
export const createParamNamesArray = (names = {}) => [
    names.mhp ?? "",
    names.mmp ?? "",
    names.atk ?? "",
    names.def ?? "",
...
export const createCommandsArray = (proto = {}) => [
    proto.fight ?? "",
    proto.escape ?? "",
    proto.attack ?? "",
    proto.guard ?? "",
...
export const createMessages = (proto = {}) => ({
...
export const createAdvanced = (proto = {}) => ({
...
export const createVehicle = (proto = {}) => ({
...
export const createSystemSoundsArray = (proto = {}) => [
