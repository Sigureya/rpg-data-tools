...
export type Table_IndexOfDesignation = {
    [K in keyof CommandTypes]: RpgTypes.IndexOfCommandParameter<CommandTypes[K], 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7>;
};
export type Table_IndexOfValiableId = {
    [K in keyof CommandTypes]: RpgTypes.IndexOfCommandParameter<CommandTypes[K], number>;
};
