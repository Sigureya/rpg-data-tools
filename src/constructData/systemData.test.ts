...
import {
  ...
  createVehicle,
  createBasicTerms,
  createParamNamesArray,
  createCommandsArray,
  createMessages,
  createSystemSoundsArray,
} from "./systemData";
import { createAudio } from "./audio";
import type { Terms_Commands } from "./types";
import type { Terms_Messages } from "@sigureya/rpgtypes";

// Mock functions for testing sub-components
...
describe("createSystemData", () => {
  ...
  it("should override default values with provided arguments", () => {
    ...
    expect(result.local).toBe(""); // Default value
  });
});
...
describe("createTerms", () => {
  ...
  it("should override default terms with provided arguments", () => {
    ...
    expect(result.commands[0]).toBe(""); // Default value
  });
});
...
describe("createAdvanced", () => {
  ...
  it("should override default advanced settings with provided arguments", () => {
    ...
    expect(result.screenHeight).toBe(0); // Default value
  });
});
...
describe("createVehicle", () => {
  ...
  it("should override default vehicle settings with provided arguments", () => {
    ...
    expect(result.startMapId).toBe(0); // Default value
  });
});
describe("createCommandsArray", () => {
  ...
  it("should return an array with custom values for all members", () => {
    ...
    expect(result).toEqual([
      ...
      "Armors", // armor
      "Key Items", // keyItem
      "Secondary Equip", // equip2
      "Optimize", // optimize
      "Clear", // clear
      "New Game", // newGame
      "Continue", // continue_
      "Unused 20", // notUsed20
      "Return to Title", // toTitle
      "Cancel", // cancel
      "Unused 23", // notUsed23
      "Buy", // buy
      "Sell", // sell
...
describe("createMessages", () => {
  ...
  it("should return an object with custom values", () => {
    const proto: Partial<Terms_Messages> = {
...
describe("createSystemSoundsArray", () => {
  ...
  it("should return an array with custom sound objects", () => {
    ...
    expect(result[0]).toBe(customAudio); // cursor
    expect(result[1]).toBe(customAudio); // ok
  });
});
